...
- Current pending prompts: `repair6-save-hang.md` (`repair5` (→`repair5-complete.md`), `repair5b-password-loop-systemic`, `repair8`, `repair9`, `repair10`, `repair11-transaction-dialog-and-dashboard`, `feature-impersonate-user`, `fix-impersonate-deploy`, `feature-attendance-v2`, `repair12-attendance-admin-sidebar-delete` are all done & live — see Phase History)
